...
const Body = () => {
    ...
    const [labeling, setLabeling] = useState('Masukan kode booking yang didapat dari M-JKN');
    ...
    const handleKirim = async () => {
        const formData = new FormData();
            ...
            const response = await fetch(process.env.NEXT_PUBLIC_SIMRS+'/antrol/api/checkinantrian', {
                method: 'POST',
